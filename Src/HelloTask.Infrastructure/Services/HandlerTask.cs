...
namespace HelloTask.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<HelloTaskException, Task> _onCustomError;
        ...
        public IHandlerTask OnCustomError(Func<HelloTaskException, Task> onCustomError, bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as HelloTaskException;
